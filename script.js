async function showTodayTimetable(id) {
	...
	try {
	  const lessonsResponse = await fetch('https://raw.githubusercontent.com/PanWor/planlekcji/master/lessons.json');
	  const lessonsData = await lessonsResponse.json();
  
	  const timetableResponse = await fetch('..https://raw.githubusercontent.com/PanWor/planlekcji/master/timetable.json');
	  ...
	  for (const lessonSlot in lessons) {
		...
		const hoursResponse = await fetch('https://raw.githubusercontent.com/PanWor/planlekcji/master/hours.json');
